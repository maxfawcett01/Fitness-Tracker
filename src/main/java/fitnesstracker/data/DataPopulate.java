...
//*******************************************************************************
        ...
        HealthStatistic healthStatistic1 = new HealthStatistic(null, 23.0,60.0, 80.0, 90.0,480.0, 620.0, 65.0, 10.0);

        healthStatisticService.createHealthStatistic(healthStatistic1) ;
        HealthStatistic healthStatistic2 = new HealthStatistic(null, 24.0,61.0, 81.0, 91.0,481.0, 621.0, 66.0, 11.0);
        ...
        WeightLiftingExercise exercise3 = new WeightLiftingExercise(person1, "Dead-lift", LocalDateTime.now(), LocalDateTime.now(), 3, 12, 100);
